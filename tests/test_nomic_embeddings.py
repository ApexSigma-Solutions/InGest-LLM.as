    ...
    try:
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            if response.status_code == 200:
                ...
                print(f"Nomic model: {'✓ Available' if nomic_available else '✗ Missing'}")
                print()
                                ...
                                if response3.status_code == 200:
                                    ...
                                    if "data" in result3 and len(result3["data"]) > 0:
                                        ...
                                        if sim_to_fastapi > sim_to_data:
                                            print("  → Project appears more similar to FastAPI code")
                                        else:
                                            print("  → Project appears more similar to data analysis code")
                                        print()
                            ...
                            if config_file.exists():
                                ...
                                if response4.status_code == 200:
                                    ...
                                    if "data" in result4 and len(result4["data"]) > 0:
                                        ...
                                        print("  → Config files have different semantic space than code")
                                        print()
