#!/usr/bin/env pwsh
# Startup script for ingest-llm service
...
Write-Host "LINEAR_WEBHOOK_SECRET: Set"
Write-Host ""

poetry run python -m uvicorn ingest_llm.main:app --host 0.0.0.0 --port 9876 --reload
