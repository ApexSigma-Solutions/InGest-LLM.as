    ...
    try:
        ...
        if response.status_code in [200, 202]:
            ...
            if verbose:
                ...
                print("  Make sure LINEAR_WEBHOOK_SECRET matches the secret used for testing")
            return False
        else:
            if verbose:
                print("✗ TEST FAILED")
...
def test_health(url: str = "http://localhost:8000/webhook/health", verbose: bool = True) -> bool:
    """
