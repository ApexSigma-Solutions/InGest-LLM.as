...
class ProjectDocumentationCLI:
    ...
    async def _generate_all_project_docs(self, force: bool) -> None:
        ...
        print()
        print(f"📊 Summary: {len(successful_projects)} successful, {len(failed_projects)} failed")
    ...
    def _show_generated_files(self, docs_dir: Path, project_name: str) -> None:
        ...
        print(f"  🎨 View diagram: Copy '{docs_dir}/{project_prefix}_diagram.mmd' to https://mermaid.live")
        print(f"  📊 Access data: Load '{docs_dir}/{project_prefix}_data.json' in your application")
