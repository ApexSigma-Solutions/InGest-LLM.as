...
class Settings(BaseSettings):
    ...
    ollama_base_url: str = Field(default="http://0.0.0.0:11434", description="Ollama API base URL")
    ...
    ollama_host_url: str = Field(default="http://localhost:11434", description="Ollama host URL for heartbeat")

    # QuiPU monitoring
    heartbeat_interval_sec: int = Field(default=60, description="Heartbeat check interval in seconds")
    quipu_service_name: str = Field(default="ollama-server-01", description="Service identifier for heartbeat records")
    ...
    postgres_db: str = Field(default="ingest_db", description="PostgreSQL database name")
    postgres_server: str = Field(default="127.0.0.1", description="PostgreSQL server address")
    postgres_port: int = Field(default=5800, description="PostgreSQL port")
    pg_conn: Optional[str] = Field(default=None, description="Legacy PostgreSQL connection string")
    ...
    neo4j_host_data_path: str = Field(default="D:/docker-data/omega_kg_stable/neo4j", description="Neo4j data path")

    # Linear integration
    linear_webhook_secret: Optional[str] = Field(default=None, description="Linear webhook secret")
    linear_team_id: str = Field(default="ALPHA", description="Linear team ID")
    linear_workspace_id: str = Field(default="ApexSigma-Solutions", description="Linear workspace ID")
    linear_project_id: str = Field(default="InGest-LLM", description="Linear project ID")

    # AI Services API keys
    nanogpt_api_key: Optional[str] = Field(default=None, description="NanoGPT API key")
    openrouter_api_key: Optional[str] = Field(default=None, description="OpenRouter API key")
    perplexity_api_key_prd: Optional[str] = Field(default=None, description="Perplexity API key (production)")
    gemini_api_key_prd: Optional[str] = Field(default=None, description="Gemini API key (production)")
    ...
    perplexity_ai_api_key: Optional[str] = Field(default=None, description="Perplexity AI API key")
    ...
    apidog_access_token: Optional[str] = Field(default=None, description="Apidog access token")
    apidog_project_id: str = Field(default="", description="Apidog project ID")

    # Paths
    obsidian_vault_path: str = Field(default="./vault", description="Path to Obsidian vault")
    ai_conversations_path: str = Field(default="./vault/AI_Conversations", description="Path to AI conversations")
    obsidian_vault_scan_folders: str = Field(default="", description="Comma-separated list of folders to scan")

    # Bitwarden Secret IDs
    linear_webhook_secret_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Linear webhook secret")
    github_webhook_secret_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for GitHub webhook secret")
    postgres_password_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for PostgreSQL password")
    neo4j_password_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Neo4j password")
    extension_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for extension API key")
    linear_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Linear API key")
    perplexity_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Perplexity API key")
    gemini_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Gemini API key")
    nanogpt_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for NanoGPT API key")
    ollama_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Ollama API key")
    hookdeck_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Hookdeck API key")
    jwt_secret_key_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for JWT secret")
    tavily_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Tavily API key")
    brave_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Brave API key")
    kagi_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Kagi API key")
    exa_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Exa API key")
    github_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for GitHub API key")
    jina_ai_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Jina AI API key")
    firecrawl_api_key_prd_id: Optional[str] = Field(default=None, description="Bitwarden secret ID for Firecrawl API key")
